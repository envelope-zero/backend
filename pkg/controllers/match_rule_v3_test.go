...
func (suite *TestSuiteStandard) TestMatchRuleV3Create() {
	a := suite.createTestAccountV3(suite.T(), models.Account{Name: "TestMatchRuleCreate"})
		...
		},
		{
			...
			func(t *testing.T) string {
				return suite.createTestMatchRuleV3(t, models.MatchRuleCreate{
					AccountID: suite.createTestAccountV3(t, models.Account{}).Data.ID,
					Match:     "TestMatch*",
				}).Data.Links.Self
			},
		},
...
func (suite *TestSuiteStandard) TestMatchRulesV3GetFilter() {
	...
	a1 := suite.createTestAccountV3(suite.T(), models.Account{BudgetID: b.Data.ID, Name: "TestMatchRulesV3GetFilter 1"})
	a2 := suite.createTestAccountV3(suite.T(), models.Account{BudgetID: b.Data.ID, Name: "TestMatchRulesV3GetFilter 2"})
...
func (suite *TestSuiteStandard) TestMatchRulesV3Create() {
	...
	internalAccount := suite.createTestAccountV3(suite.T(), models.Account{External: false, BudgetID: budget.Data.ID, Name: "TestMatchRulesV3Create Internal"})
...
func (suite *TestSuiteStandard) TestMatchRulesV3GetSingle() {
	tests := []struct {
	...
	}{
		{
			...
			"",
			func(t *testing.T) string {
				return suite.createTestMatchRuleV3(t, models.MatchRuleCreate{AccountID: suite.createTestAccountV3(t, models.Account{}).Data.ID}).Data.Links.Self
			},
		},
		{
			"Invalid UUID",
...
func (suite *TestSuiteStandard) TestMatchRulesV3UpdateFail() {
	m := suite.createTestMatchRuleV3(suite.T(), models.MatchRuleCreate{
		AccountID: suite.createTestAccountV3(suite.T(), models.Account{}).Data.ID,
		Match:     "Some match*",
	})
...
func (suite *TestSuiteStandard) TestMatchRulesV3Update() {
	...
	newAccount := suite.createTestAccountV3(suite.T(), models.Account{})
...
func (suite *TestSuiteStandard) TestMatchRulesV3GetSorted() {
	b := suite.createTestBudgetV3(suite.T(), models.BudgetCreate{})
	a := suite.createTestAccountV3(suite.T(), models.Account{BudgetID: b.Data.ID, Name: "TestMatchRulesV3GetFilter 1"})
