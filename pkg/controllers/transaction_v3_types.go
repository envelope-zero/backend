...
type TransactionV3Editable struct {
...
func (editable TransactionV3Editable) model() models.Transaction {
...
type TransactionV3Links struct {
...
type TransactionV3 struct {
	models.DefaultModel
	TransactionV3Editable
	Links TransactionV3Links `json:"links"`
}

// newTransactionV3 returns the API v3 representation of the resource
func newTransactionV3(c *gin.Context, model models.Transaction) TransactionV3 {
	url := c.GetString(string(database.ContextURL))

	return TransactionV3{
		DefaultModel: model.DefaultModel,
		TransactionV3Editable: TransactionV3Editable{
			Date:                  model.Date,
			Amount:                model.Amount,
			Note:                  model.Note,
		...
		Links: TransactionV3Links{
			Self: fmt.Sprintf("%s/v3/transactions/%s", url, model.ID),
		},
	}
}
...
func (f TransactionQueryFilterV3) model() (models.Transaction, httperrors.Error) {
