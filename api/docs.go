            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/v5.BudgetListResponse"
                        }
                    },
                    "500": {
                        "description": "Internal Server Error",
            ...
            "post": {
                ...
                "parameters": [
                    {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/v5.BudgetEditable"
                            }
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/v5.BudgetCreateResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/v5.BudgetResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        ...
        "root.Links": {
            ...
            "properties": {
                ...
                "v5": {
                    "description": "List endpoint for all v5 endpoints",
                    "type": "string",
                    "example": "https://example.com/api/v5"
                },
                "version": {
        ...
        "v5.Budget": {
            ...
            "properties": {
                ...
                "links": {
                    "$ref": "#/definitions/v5.BudgetLinks"
                },
                "name": {
                    "description": "Name of the budget",
                    "type": "string",
        ...
        "v5.BudgetCreateResponse": {
            ...
            "properties": {
                "data": {
                    ...
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/v5.BudgetCreatedResponse"
                    }
                }
            }
        },
        "v5.BudgetCreatedResponse": {
            "type": "object",
            "properties": {
                "data": {
                    "description": "Data for the budget",
        ...
        "v5.BudgetLinks": {
            ...
            "properties": {
                "accounts": {
                    "description": "Accounts for this budget",
                    "type": "string",
                    "example": "https://example.com/api/v5/accounts?budget=550dc009-cea6-4c12-b2a5-03446eb7b7cf"
                },
                "categories": {
                    "description": "Categories for this budget",
                    "type": "string",
                    "example": "https://example.com/api/v5/categories?budget=550dc009-cea6-4c12-b2a5-03446eb7b7cf"
                },
                "envelopes": {
                    "description": "Envelopes for this budget",
                    "type": "string",
                    "example": "https://example.com/api/v5/envelopes?budget=550dc009-cea6-4c12-b2a5-03446eb7b7cf"
                },
                "month": {
                    "description": "This uses 'YYYY-MM' for clients to replace with the actual year and month.",
                    "type": "string",
                    "example": "https://example.com/api/v5/months?budget=550dc009-cea6-4c12-b2a5-03446eb7b7cf\u0026month=YYYY-MM"
                },
                "self": {
                    "description": "The budget itself",
                    "type": "string",
                    "example": "https://example.com/api/v5/budgets/550dc009-cea6-4c12-b2a5-03446eb7b7cf"
                },
                "transactions": {
                    "description": "Transactions for this budget",
                    "type": "string",
                    "example": "https://example.com/api/v5/transactions?budget=550dc009-cea6-4c12-b2a5-03446eb7b7cf"
                }
            }
        },
        "v5.BudgetListResponse": {
            "type": "object",
            "properties": {
                "data": {
                    "description": "List of budgets",
        ...
        "v5.Links": {
            ...
            "properties": {
                "budgets": {
                    "description": "Accounts     string ` + "`" + `json:\"accounts\" example:\"https://example.com/api/v5/accounts\"` + "`" + `         // URL of Account collection endpoint",
                    "type": "string",
                    "example": "https://example.com/api/v5/budgets"
                }
            }
        },
        "v5.Pagination": {
        ...
        "v5.Response": {
            ...
            "properties": {
                "links": {
                    "description": "Links for the v5 API",
                    "allOf": [
                        {
                            "$ref": "#/definitions/v5.Links"
                        }
                    ]
                }
            }
