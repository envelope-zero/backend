...
const docTemplate = `{
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/controllers.AccountListResponseV3"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "post": {
                ...
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/controllers.AccountCreateResponseV3"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/controllers.AccountResponseV3"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/controllers.CategoryListResponseV3"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "post": {
                ...
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/controllers.CategoryCreateResponseV3"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/controllers.CategoryResponseV3"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        ...
        "controllers.AccountCreateResponseV3": {
            "type": "object",
            "properties": {
                "data": {
        ...
        "controllers.AccountListResponseV3": {
            ...
            "properties": {
                "data": {
                    ...
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/controllers.AccountV3"
                    }
                },
                "error": {
                    "description": "The error, if any occurred",
        ...
        "controllers.CategoryCreateResponseV3": {
            "type": "object",
            "properties": {
                "data": {
        ...
        "controllers.CategoryListResponseV3": {
            "type": "object",
            "properties": {
                "data": {
                    "description": "List of Categories",
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/controllers.CategoryV3"
                    }
                },
                "error": {
                    "description": "The error, if any occurred",
        ...
        "controllers.CategoryResponseV3": {
            "type": "object",
            "properties": {
                "data": {
                    "description": "Data for the Category",
